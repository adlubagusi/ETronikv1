...
import com.adlubagusi.e_tronikv1.Model.Cart;
import com.adlubagusi.e_tronikv1.Prevalent.Prevalent;
import com.adlubagusi.e_tronikv1.ViewHolder.CartViewHolder;
...
public class CartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextProccessBtn = findViewById(R.id.next_proccess_btn);
        ...
        nextProccessBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                txtTotalAmount.setText("Total Harga : Rp "+String.valueOf(overTotalPrice));
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    ...
                    if(shippingState.equals("Dikirim")){
                        txtTotalAmount.setText("Kepada "+userName+"\n Pesanan Anda sudah dikirim ke alamat anda");
                        recyclerView.setVisibility(View.GONE);
                        txtMsg1.setVisibility(View.VISIBLE);
                        txtMsg1.setText("Selamat! Pesanan Anda berhasil dikirim. Anda akan segera menerima pesanan anda.");
                        nextProccessBtn.setVisibility(View.GONE);
                        Toast.makeText(CartActivity.this, "Anda bisa membeli lebih banyak produk, setelah Anda menerima pesanan anda ", Toast.LENGTH_SHORT).show();
