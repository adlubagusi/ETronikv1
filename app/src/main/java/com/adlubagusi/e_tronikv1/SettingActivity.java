...
public class SettingActivity extends AppCompatActivity
{
    ...
    private void updateOnlyUserInfo()
    {
        ...
        Toast.makeText(SettingActivity.this, "Profil Berhasil Di Ganti.", Toast.LENGTH_SHORT).show();
        finish();
    }
    ...
    private void uploadImage()
    {
        ...
        progressDialog.setMessage("Harap tunggu, kami sedang mengubah informasi profil anda");
